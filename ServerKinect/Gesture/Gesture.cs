...
namespace Fizbin.Kinect.Gestures
{
    class Gesture
    {
        ...
        /// </summary>
        private int pausedFrameCount = 25;
        ...
        public void UpdateGesture(SkeletonsData data)
        {
            if (this.paused)
            {
            ...
            if (result == GesturePartResult.Succeed)
            {
                ...
                else
                {
                    ...
                    {
                        this.GestureRecognized(this, new GestureEventArgs(this.name, data.getSkeletonID()));
                        this.Reset();
                    }
                }
            }
