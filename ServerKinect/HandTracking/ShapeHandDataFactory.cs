...
namespace ServerKinect.HandTracking
{
    internal class ShapeHandDataFactory : IHandDataFactory
    {
        ...
        {
            var map = new DistanceMap<HandData, Shape.Shape>(currentValue.Hands);
        ...
        private HandData Create(Shape.Shape shape)
        {
            return this.Create(idGenerator.GetNextId(), shape, new List<FingerPoint>());
        }

        private HandData Create(HandData lastFrameData, Shape.Shape shape)
        {
        ...
        private HandData Create(int id, Shape.Shape shape, IList<FingerPoint> lastFrameFingerPoints)
        {
        ...
        private Palm DetectPalm(Shape.Shape shape, Contour contour)
        {
