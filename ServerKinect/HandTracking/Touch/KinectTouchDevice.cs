...
namespace ServerKinect.HandTracking.Touch
{
    ...
    internal class KinectTouchDevice : TouchDevice, IDisposable
    {
        ...
        public override TouchPoint GetTouchPoint(IInputElement relativeTo)
        {
            ...
            if (relativeTo != null)
            {
                point = this.ActiveSource.RootVisual.TransformToDescendant((System.Windows.Media.Visual)relativeTo).Transform(point);
            }
